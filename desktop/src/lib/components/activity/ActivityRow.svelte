...
<script lang="ts">
  ...
  const EVENT_ICONS: Record<ActivityEventType, { path: string; color: string }> = {
    ...
    agent_slept:            { path: 'M20.354 15.354A9 9 0 0 1 8.646 3.646 9.003 9.003 0 0 0 12 21a9.003 9.003 0 0 0 8.354-5.646z', color: '#f97316' },
    ...
    skill_triggered:        { path: 'M13 10V3L4 14h7v7l9-11h-7z', color: '#f97316' },
    ...
    deployment:             { path: 'M7 16a4 4 0 0 1-.88-7.903A5 5 0 1 1 15.9 6L16 6a5 5 0 0 1 1 9.9M15 13l-3-3m0 0-3 3m3-3v12', color: '#fb923c' },
  };

    ...
    },
    {
      ...
      articles: [
        ...
        },
        {
          ...
          route: '/app/inbox',
          description:
            'The inbox is your unified notification center combining approval requests, system alerts, agent mentions, failure notifications, reports, and budget warnings.',
          useCase:
            'Check the inbox when you see a badge count in the sidebar — it means agents need your attention, approvals are pending, or something requires human intervention.',
          configuration: [
            'Filter by type: approval, alert, mention, failure, report, budget_warning',
      ...
      articles: [
        {
          ...
          capabilities: [
            ...
            'Hire agents from 330+ templates in the library',
      ...
      articles: [
        {
          ...
          route: '/app/skills',
          description:
            'Skills are capabilities that agents can use — tools, integrations, and specialized behaviors. Enable or disable skills workspace-wide from this page.',
          useCase:
            'Control what your agents can do by toggling skills on and off. For example, enable "web_search" for research agents but disable it for code-only agents.',
          configuration: [
      ...
      articles: [
        {
          ...
          route: '/app/library',
          description:
            'The library is a marketplace-style catalog of pre-built agent templates, skills, team configurations, and company operation blueprints. Browse, search, and deploy with one click.',
          useCase:
            'Use the library to quickly staff your workspace. Instead of configuring agents from scratch, deploy proven templates with pre-configured skills, prompts, and team structures.',
          configuration: [
            'Tabs: Agents, Skills, Teams, Companies',
            'Search with debounced input',
            'Category filters per tab',
            'Sort: featured, name, newest, popular',
            'View mode: grid or list',
          ],
          capabilities: [
            '330+ agent templates across many domains',
            'Skill catalog with enable/deploy',
            'Team templates that deploy multiple agents in a configured hierarchy',
            'Company operation blueprints for entire business units',
            'One-click deploy with automatic agent provisioning',
            'Preview agent stats, capabilities, and budget estimates before deploying',
          ],
          tips: [
    ...
    },
    {
      ...
      articles: [
        ...
        },
        {
          ...
          description:
            'Integrations manages connections to external services and AI adapters. Install adapters, check their health, and configure the OSA setup flow.',
          useCase:
            'Connect BizForge to your AI providers and external tools. Install the OSA adapter for local model execution, or configure cloud adapters for Claude, GPT, etc.',
          configuration: [

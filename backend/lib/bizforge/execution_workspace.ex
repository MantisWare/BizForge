defmodule Bizforge.ExecutionWorkspace do
  @moduledoc """
  ...
  - `:branch_prefix` — prefix for worktree branch name (default: `"bizforge-heartbeat"`)
  """
  ...
  def create(project_path, opts \\ []) do
    ...
    branch_prefix = Keyword.get(opts, :branch_prefix, "bizforge-heartbeat")

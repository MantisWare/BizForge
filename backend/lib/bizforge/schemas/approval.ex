defmodule Bizforge.Schemas.Approval do
  use Ecto.Schema
  ...
  schema "approvals" do
    ...
    belongs_to :requested_by_agent, Bizforge.Schemas.Agent, foreign_key: :requested_by
    belongs_to :reviewer, Bizforge.Schemas.User
    belongs_to :workspace, Bizforge.Schemas.Workspace
    has_many :approval_comments, Bizforge.Schemas.ApprovalComment

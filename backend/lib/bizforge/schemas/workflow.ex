defmodule Bizforge.Schemas.Workflow do
  use Ecto.Schema
  ...
  schema "workflows" do
    ...
    has_many :steps, Bizforge.Schemas.WorkflowStep, preload_order: [asc: :position]
    has_many :runs, Bizforge.Schemas.WorkflowRun

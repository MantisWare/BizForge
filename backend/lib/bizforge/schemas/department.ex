defmodule Bizforge.Schemas.Department do
  use Ecto.Schema
  ...
  schema "departments" do
    ...
    belongs_to :division, Bizforge.Schemas.Division
    belongs_to :head_agent, Bizforge.Schemas.Agent, foreign_key: :head_agent_id
    has_many :teams, Bizforge.Schemas.Team

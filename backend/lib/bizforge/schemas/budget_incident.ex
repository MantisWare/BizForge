defmodule Bizforge.Schemas.BudgetIncident do
  use Ecto.Schema
  ...
  schema "budget_incidents" do
    ...
    belongs_to :policy, Bizforge.Schemas.BudgetPolicy
    belongs_to :agent, Bizforge.Schemas.Agent
    belongs_to :resolved_by_user, Bizforge.Schemas.User, foreign_key: :resolved_by
  end

defmodule Bizforge.AlertEvaluator do
  @moduledoc """
  ...
  alias Bizforge.Repo
  alias Bizforge.Schemas.{AlertRule, AlertHistory, Agent, Session}
  import Ecto.Query
  ...
  defp fire_alert(rule, entity_value) do
    ...
    # Broadcast
    Bizforge.EventBus.broadcast(Bizforge.EventBus.activity_topic(), %{

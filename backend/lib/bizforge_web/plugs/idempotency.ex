defmodule BizforgeWeb.Plugs.Idempotency do
  @moduledoc """
  ...
  @table :bizforge_idempotency_cache
  @ttl_seconds 86_400
  ...
  @doc "Run expired entry cleanup. Called by Bizforge.IdempotencyCleanup or manually."

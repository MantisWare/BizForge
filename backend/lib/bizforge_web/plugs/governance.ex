defmodule BizforgeWeb.Plugs.Governance do
  @moduledoc """
  ...
  Usage in a controller:
    plug BizforgeWeb.Plugs.Governance, action: :spawn_agent when action in [:create]
    plug BizforgeWeb.Plugs.Governance, action: :delete_agent when action in [:delete]
  ...
  def call(conn, opts) do
    ...
    case Bizforge.Governance.Gate.check(action_type, params) do
      :allowed ->
        conn
  ...
  defp infer_workspace_from_agent(agent_id) do
    case Bizforge.Repo.get(Bizforge.Schemas.Agent, agent_id) do

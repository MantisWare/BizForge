defmodule BizforgeWeb.LogController do
  ...
  def index(conn, params) do
    ...
    query =
      from e in Bizforge.Schemas.ActivityEvent,
        left_join: a in Bizforge.Schemas.Agent,
        on: e.agent_id == a.id,
  ...
  def stream(conn, params) do
    ...
    topic =
      case params["workspace_id"] do
        nil -> Bizforge.EventBus.logs_topic()
        workspace_id -> Bizforge.EventBus.workspace_topic(workspace_id)
      end
    ...
    Bizforge.EventBus.subscribe(topic)

defmodule BizforgeWeb.EnvironmentController do
  use BizforgeWeb, :controller

  alias Bizforge.Repo
  alias Bizforge.Schemas.{AppPermission, AgentApp}
  import Ecto.Query
      ...
      if Enum.empty?(db_apps) do
        ...
        [
          %{
            ...
            status: "running",
            port: 3000,
            directory: "/tmp/bizforge/apps/content-os",
          ...
          %{
            ...
            status: "running",
            port: 8080,
            directory: "/tmp/bizforge/apps/data-pipeline",
            created_at: DateTime.utc_now() |> DateTime.to_iso8601()
          },
          %{
            id: "aapp-3",
            ...
            status: "building",
            port: nil,
            directory: "/tmp/bizforge/apps/analytics",
            created_at: DateTime.utc_now() |> DateTime.to_iso8601()
          }
        ]
      else

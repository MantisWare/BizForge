defmodule Bizforge.Governance.ExecutorTest do
  use Bizforge.DataCase

  import Bizforge.TestHelpers

  alias Bizforge.Governance.Executor
  ...
  describe "execute/1" do
    ...
    test "executes delete_agent action for approved approval" do
      ...
      updated = Repo.get!(Bizforge.Schemas.Agent, agent.id)
    ...
    test "executes budget_override action for approved approval" do
      ...
      {:ok, incident} =
        %Bizforge.Schemas.BudgetIncident{}
        |> Bizforge.Schemas.BudgetIncident.changeset(%{
          policy_id: policy.id,
      ...
      updated = Repo.get!(Bizforge.Schemas.BudgetIncident, incident.id)
